...
# Printing of results
print('\n Phi Partial differentiation 1 =')
sm.pprint(dphi_F_eq)
print('\n Phi Partial differentiation 2 =')
sm.pprint(dphi_x3_eq)
print('\n Phi Partial differentiation 3 =')
sm.pprint(dphi_x4_eq)

print('\n Psi Partial differentiation 1 =')
sm.pprint(dpsi_F_eq)
print('\n Psi Partial differentiation 2 =')
sm.pprint(dpsi_x3_eq)
print('\n Psi Partial differentiation 3 =')
sm.pprint(dpsi_x4_eq)

# Printing in latex form
print('\n Latex form: Phi Partial differentiation 1 = ')
print(sm.latex(dphi_F_eq))
print('\n Latex form: Phi Partial differentiation 2 = ')
print(sm.latex(dphi_x3_eq))
print('\n Latex form: Phi Partial differentiation 3 = ')
print(sm.latex(dphi_x4_eq))

print('\n Latex form: Psi Partial differentiation 1 = ')
print(sm.latex(dpsi_F_eq))
print('\n Latex form: Psi Partial differentiation 2 = ')
print(sm.latex(dpsi_x3_eq))
print('\n Latex form: Psi Partial differentiation 3 = ')
print(sm.latex(dpsi_x4_eq))
